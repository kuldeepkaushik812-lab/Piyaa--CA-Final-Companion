  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        includeAssets: ['favicon.svg', 'icons/logo.svg', 'icons/apple-touch-icon.png', 'icons/pwa-icon.svg', 'icons/pwa-192x192.png', 'icons/pwa-512x512.png', 'icons/icon-192x192.png', 'icons/icon-512x512.png'],
        manifest: {
