...
const ChapterRow = ({ 
  ...
  return (
    <div className={`flex items-center gap-2 text-xs p-2.5 sm:p-3 rounded-xl transition-all border ${
      isAllComplete 
      ...
      <div className="flex gap-1 sm:gap-1.5 shrink-0 justify-end items-center w-[150px] sm:w-[180px]">
        ...
        {/* Rev 1 */}
        <button 
          onClick={() => handleAction(() => onToggleTopicRevision(subjectId, topic.id, 1))} 
          className={`w-10 sm:w-12 h-7 rounded-lg flex items-center justify-center transition-all cursor-pointer ${
            topic.rev1 
        ...
        {/* Rev 2 */}
        <button 
          onClick={() => handleAction(() => onToggleTopicRevision(subjectId, topic.id, 2))} 
          className={`w-10 sm:w-12 h-7 rounded-lg flex items-center justify-center transition-all cursor-pointer ${
            topic.rev2 
        ...
        {/* Rev 3 */}
        <button 
          onClick={() => handleAction(() => onToggleTopicRevision(subjectId, topic.id, 3))} 
          className={`w-10 sm:w-12 h-7 rounded-lg flex items-center justify-center transition-all cursor-pointer ${
            topic.rev3 
        ...
        {/* LDR Bookmark */}
        <button 
          onClick={() => handleAction(() => onToggleTopicRevision(subjectId, topic.id, 4))} 
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {matchingTopics.length > 0 ? (
                        ...
                        <div className="p-4 rounded-xl bg-slate-900/50 border border-white/5 text-center text-xs text-slate-400 font-medium">
