...
import { X, User, ShieldCheck, Sparkles, LogOut, ChevronRight, BookOpen, Settings } from 'lucide-react';
...
export const ProfileModal: React.FC<ProfileModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-[#0B1528]/95 backdrop-blur-md animate-in fade-in duration-200">
      <div className={`w-full max-w-lg rounded-2xl border ${accentBorder} bg-[#0B1528] p-6 shadow-2xl relative space-y-6 text-slate-100 max-h-[90vh] overflow-y-auto`}>
